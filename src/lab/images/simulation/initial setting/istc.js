...
function magic()
{
	...
	function step2()
	{
			...
			myStopFunction();
			document.getElementById('77').style.visibility="hidden";
...
function refresh()
{
	...
	document.getElementById('final5').style.visibility="hidden";
	...
	document.getElementById('final55').style.visibility="hidden";
	document.getElementById('final66').style.visibility="hidden";
	document.getElementById('final77').style.visibility="hidden";
	document.getElementById('final88').style.visibility="hidden";
	document.getElementById('final99').style.visibility="hidden";
