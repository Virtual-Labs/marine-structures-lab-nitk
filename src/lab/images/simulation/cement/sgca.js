	...
	function step1()
{
	...
	setTimeout(function()
	{
		...
		document.getElementById('v1').innerHTML=+values[lnt][0]+" gm";
	}, 1200);
}
...
function step23()
{
	...
	setTimeout(function()
	{
	  ...
	  {
		document.getElementById('v2').innerHTML=+values[lnt][1]+" gm";
      }
...
function step33()
{
	...
	setTimeout(function()
	{
        ...
        document.getElementById('v3').innerHTML=+values[lnt][2]+" gm";
...
function step43()
{
	...
	setTimeout(function()
	{
		...
		document.getElementById('v4').innerHTML=+values[lnt][3]+" gm";
...
function step53()
{
	...
	setTimeout(function()
	{
		...
		if(repeat>1)
		{
		document.getElementById('v5').innerHTML=+values[lnt][4]+" gm";
        }
		else
		{
		 document.getElementById('v5').innerHTML=+values[lnt][4]+".00 gm";
        }
	}, 1200);
}
function refresh1()
{
	...
	document.getElementById('can6-6').innerHTML=" Specific gravity of kerosene =";
	 ...
	 document.getElementById('can6-7').innerHTML="Actual Specific gravity of cement   =";
	 document.getElementById('can6-8').innerHTML="Entered Specific gravity of cement  =";				    
	 document.getElementById('can6-9').innerHTML="Percentage(%) Error =";		 
...
function checkval()
{
    ...
    document.getElementById('can6-7').innerHTML="Actual Specific gravity of cement   =" +values[lnt][7];
	document.getElementById('can6-8').innerHTML="Entered Specific gravity of cement  =" +n;				    
	document.getElementById('can6-9').innerHTML="Percentage(%) Error =" +p.toFixed(2);
    if(repeat<5)
	{		
	setTimeout(function()
	{
	...
	else if(repeat==5)
	{
         ...
         document.getElementById('can6-11').innerHTML=" Average Specific gravity of cement = 3.14";
         document.getElementById('nextButton').style.visibility="hidden";
